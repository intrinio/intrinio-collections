...
/// <summary>
/// A read thread-safe, write not thread-safe implementation of the IRingBuffer (single producer and multiple consumer).  Full behavior: the oldest block in the ring buffer will be dropped. 
/// </summary>
public class DropOldestSingleProducerRingBuffer : IRingBuffer
{
    #region Data Members
    ...
    public DropOldestSingleProducerRingBuffer(uint blockSize, uint blockCapacity)
    {
